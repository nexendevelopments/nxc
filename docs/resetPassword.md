...
This document is if for you loose admin access to NEXENCloud

First Access the container / host where NEXENCloud is running

```
# Access the host running NEXENCloud
