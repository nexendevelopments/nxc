...
git clone https://github.com/turtle0x1/NexenCloud.git

mkdir -p /var/www/NexenCloud/src/sensitiveData/certs
mkdir -p /var/www/NexenCloud/src/sensitiveData/backups
chown -R apache:apache /var/www/NexenCloud/src/sensitiveData/
chown -R apache:apache /var/www/NexenCloud/src/sensitiveData/backups

# Move in LxdManager
cd /var/www/NexenCloud || exit
...
openssl req -new -newkey rsa:2048 -days 3650 -nodes -x509 \
            -subj "/C=NA/ST=NoState/L=NoLocale/O=Blah/CN=cloud" \
...
echo "* * * * * apache cd /var/www/NexenCloud/ && vendor/bin/crunz schedule:run" >> /etc/crontab
